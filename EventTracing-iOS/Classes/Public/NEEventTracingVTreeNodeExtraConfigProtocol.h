//
//  NEEventTracingVTreeNodeExtraConfigProtocol.h
//  NEEventTracing
//
...
@protocol NEEventTracingVTreeNodeExtraConfigProtocol <NSObject>
...
- (NSArray<NSString *> *)ne_et_validForContainingSubNodeOids;
