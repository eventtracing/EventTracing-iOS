...
- (void)viewDidLoad {
    ...
    [NEEventTracingBuilder viewController:self pageId:@"page_alert"];
...
- (void)addShowAlertBtn {
    ...
    [NEEventTracingBuilder view:showAlertBtn elementId:@"btn_show_alert"];
...
- (void)addShowActionSheetBtn {
    ...
    [NEEventTracingBuilder view:btn elementId:@"btn_show_sheet"];
...
- (void)showAlert {
    ...
    [[NEEventTracingBuilder viewController:alert pageId:pageId] build:^(id<NEEventTracingLogNodeBuilder>  _Nonnull builder) {
        builder
        .params
        .ctype(@"alert")
    ...
    [OK ne_et_setElementId:@"btn" position:1 params:@{
    ...
    [alert ne_et_configLastestActionWithElementId:@"btn" position:2 params:@{
...
- (void)showActionSheet {
    ...
    [[NEEventTracingBuilder viewController:sheet pageId:pageId] build:^(id<NEEventTracingLogNodeBuilder>  _Nonnull builder) {
        builder
        .params
        .ctype(@"sheet")
        .cid([NSUUID UUID].UUIDString);
    ...
    [OK ne_et_setElementId:@"btn_handsome_boy" position:1 params:@{
    ...
    [sheet ne_et_configLastestActionWithElementId:@"btn_cancel" position:2 params:@{
